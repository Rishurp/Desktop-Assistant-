...
int main()
{
    ...
    cout<<"\t\t\t<============================================= I'M A DESKTOP ASSISTANT ==========================================>"<<endl;
    cout<<"\t\t\t<============================================= MY NAME IS SAADHU  ==========================================>"<<endl;
        ...
        if(strcmp(password, "flick")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by my master Rishu Pandey !!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master Rishu Pandey";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
